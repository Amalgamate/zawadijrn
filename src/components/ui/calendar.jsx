    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                nav_button: cn(
                    "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 border border-slate-200 hover:bg-slate-100 hover:text-slate-900 rounded-md flex items-center justify-center transition-opacity"
                ),
