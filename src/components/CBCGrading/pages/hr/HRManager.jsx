...
import {
    ...
    AlertCircle, TrendingUp, Briefcase, Activity
} from 'lucide-react';
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <StatCard title="On Leave / Pending" value={stats?.pendingLeaveCount ?? '—'} icon={Calendar}  color="purple" sub="Awaiting approval" />
                <StatCard title="Payroll Status" value={payrollLabel}                        icon={Clock}     color="orange" sub={payrollSub} />
                <StatCard title="Recent Requests" value={stats?.recentRequests?.length ?? 0} icon={CheckCircle} color="emerald" sub="Pending this month" />
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                {/* Sidebar: Pending Leave Requests */}
