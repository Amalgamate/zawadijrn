    ...
    <div className="flex-1 p-6 overflow-y-auto space-y-6">
      ...
      <div className="flex justify-between items-end bg-brand-purple p-8 rounded-2xl text-white shadow-xl relative overflow-hidden">
        ...
        <div className="relative z-10 w-full relative">
            <h1 className="text-3xl font-medium tracking-tight mb-2">Learning Management System</h1>
            ...
            <div className="mt-6 flex gap-4">
                <button className="bg-white text-brand-purple px-6 py-2.5 rounded-lg font-medium shadow hover:bg-gray-50 transition-colors">
                    Create New Course
                </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm flex items-center gap-4">
              ...
              <div>
                  ...
                  <p className="text-2xl font-medium text-gray-800">438</p>
              </div>
          </div>
          <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm flex items-center gap-4">
              ...
              <div>
                  ...
                  <p className="text-2xl font-medium text-gray-800">14d</p>
              </div>
          </div>
          <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm flex items-center gap-4">
              ...
              <div>
                  ...
                  <p className="text-2xl font-medium text-gray-800">89</p>
              </div>
          </div>
      </div>
