...
const Sidebar = React.memo(({
  ...
  return (
    <div className={`${sidebarOpen ? 'w-52' : 'w-20'} bg-[var(--sidebar-bg)] text-white transition-all duration-300 flex flex-col border-r border-white/10 dark:border-slate-800 shadow-lg`}>
      {/* Logo/Brand with Premium Styling */}
      <div className="h-20 p-5 border-b border-white/10 dark:border-slate-800 bg-[var(--sidebar-bg)] relative overflow-hidden">
      ...
      {/* Navigation */}
      <nav className="flex-1 overflow-y-auto p-3 bg-[var(--sidebar-bg)] custom-scrollbar space-y-2">
