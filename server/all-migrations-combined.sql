...
-- AlterTable
ALTER TABLE "schools" ADD COLUMN     "stampUrl" TEXT;
-- AlterTable
ALTER TABLE "schools" ADD COLUMN     "latitude" DOUBLE PRECISION,
ADD COLUMN     "longitude" DOUBLE PRECISION;
-- AlterTable
ALTER TABLE "schools" ADD COLUMN     "brandColor" TEXT,
ADD COLUMN     "onboardingMessage" TEXT,
ADD COLUMN     "onboardingTitle" TEXT,
