# Trends CORE V1.0 — Architecture

## System Design: Single-Tenant

Trends CORE V1.0 is a **single-school system**. It serves exactly one school installation. There is no concept of tenants, subdomains, branches, plans, subscriptions, or trial periods anywhere in this codebase.
